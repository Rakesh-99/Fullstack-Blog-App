        ...
        <>
            ...
            <div className="min-h-screen flex flex-col items-center justify-center w-full">
                <div className="flex w-full relative justify-start md:pl-20 ">
                    ...
                    >Rakesh Kumar Parida.</motion.span>
